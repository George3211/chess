...
class Board:
    ...
    def _add_pieces(self, color):
        ...
        self.squares[row_other][2] = Square(row_other, 2, Knight(color))
        self.squares[row_other][5] = Square(row_other, 5, Knight(color))

        # Rooks

        self.squares[row_other][0] = Square(row_other, 0, Knight(color))
